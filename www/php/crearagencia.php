...
<head>
  ...
  function modificar(valor){
  	var v=valor;
  	window.open("modificaragencia.php?codigo="+v,"Cantidad","width=350,height=250,top=25,left=350");
  	return false;
  }
  function nueva(){
  	window.open("nuevaagencia.php","Cantidad","width=350,height=250,top=150,left=400");
  	return false;
  }

  function eliminar(valor){
  	var v=valor;
  	window.open("eliminaragencia.php?codigo="+v,"Cantidad","width=300,height=150,top=300,left=400");
  	return false;
  }
...
<div class="row">
    ...
    <div class="col-md-1">
    <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="rigth" title = "Crear nueva Agencia" onclick = "nueva()">
        <input type="image" style="cursor:pointer" name="btn_cliente" id="btn_cliente" src="../bootstrap/fonts/glyphicons/glyphicons/glyphicons-37-file.png"  value="" title = "Registrar Nueva Agencia" onclick = "nueva()"/>
        </button>
        </div>
         </div>
   ...
   if(!$val){
      echo "<tr><td>".mysqli_error()."</td></tr>";
	   ...
	   while($row = mysqli_fetch_array($val)){
		   $cant ++;
			echo "<tr>";
			echo "<td align=\"center\">".$row['codigo_agencia']."</td>";
			echo "<td><strong>".$row['nombre_agencia']."</strong></td>";

			echo '<td align="center"><input type="image" style="cursor:pointer" name="btn_cliente" id="btn_cliente" src="../bootstrap/fonts/glyphicons/glyphicons/glyphicons-151-edit.png" value="" data-toggle="tooltip" data-placement="left" title = "Modificar Agencia" onclick = "modificar('.$row['codigo_agencia'].')"/></td>';
			
			echo '<td align="center"><input type="image" style="cursor:pointer" name="btn_cliente" id="btn_cliente" src="../bootstrap/fonts/glyphicons/glyphicons/glyphicons-17-bin.png" value="" data-toggle="tooltip" data-placement="left" title = "Eliminar Agencia" onclick = "eliminar('.$row['codigo_agencia'].')"/></td>';
			
			echo "</tr>";
	 }
	 			echo "<tr>
				      <td  align='right'><strong>".$cant. "</strong></td>
					  <td>Agencias registradas</td>
				      </tr>";						
   }
  ?>
  </tbody>   
