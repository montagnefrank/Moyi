...
if (!isset($_POST['buscar'])) {
    ...
    while ($rowag = mysqli_fetch_array($valag)) {
        ...
        $sql = "SELECT distinct fecha,fecha_tentativa FROM tbletiquetasxfinca where finca='" . $finca . "' AND archivada = 'No'  AND estado!= '5' AND estado!= '2' AND agencia='" . $rowag['agencia'] . "' order by fecha";
        ...
        while ($row = mysqli_fetch_array($val)) {
            ...
            while ($fila = mysqli_fetch_array($consulta)) {
                ...
                $sql1 = "SELECT SUM(solicitado) as solicitado,SUM(entregado) as entregado, item, fecha, precio FROM tbletiquetasxfinca where fecha='" . $row['fecha'] . "' AND finca='" . $finca . "' AND estado!='5' AND item = '" . $fila['item'] . "' AND agencia='" . $rowag['agencia'] . "' AND archivada = 'No'";
