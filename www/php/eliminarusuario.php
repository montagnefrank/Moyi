...
<form id="form1" name="form1" method="post" action="">
  <table width="300" border="0" align="center" class="alert">
    <tr>
      <td height="30" colspan="2"><strong><span id="result_box" lang="en" xml:lang="en">Esta seguro de eliminar el usuario</span>?</strong></td>
    </tr>
    <tr>
  ...
  $sql="DELETE FROM tblusuario WHERE id_usuario='".$codi."'";
  $eliminado= mysqli_query($link, $sql);
  	if($eliminado){
		echo("<script> alert ('Usuario eliminado correctamente');
		               window.close();					   window.opener.document.location='usuarios.php';
		     </script>");
	 }else{
