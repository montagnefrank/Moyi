    ...
    <head>
        ...
        <script>
            function print1(finca, fecha) {
                window.open("print.php?finca=" + finca + "&fecha=" + fecha + "", "Imprimir", "width=300,height=200,top=200,left=350");
                return false;
            }
            function print2(finca, fecha, item) {
                window.open("print.php?finca=" + finca + "&fecha=" + fecha + "&item=" + item + "", "Imprimir", "width=300,height=200,top=200,left=350");
                return false;
            }
            function print3(finca, fecha, item) {
                                        ...
                                        while ($row = mysql_fetch_array($val)) {
                                            ...
                                            while ($fila = mysql_fetch_array($consulta)) {
                                                ...
                                                if ($dif != 0) {
                                                    ...
                                                    echo '<td align="center"><a href="#" style="cursor:not-allowed" ><img src="../images/print.png" name="btn_cliente" id="btn_cliente" data-toggle="tooltip" data-placement="left" title = "Imprimir etiquetas de esta fecha" width="20" height="20"/></a></td>';
                                                    echo "</tr>";
                                                }
                                            }//fin while
                                            ...
                                            if ($totaldif == 0) {
                                                ...
                                                echo '<td align="center"><button class="btn btn-primary" onclick="print3(\'' . $rowag['finca'] . '\',\'' . $row['fecha'] . '\',\'' . $row1['item'] . '\')" title = "Reimprimir etiquetas disponibles"><span class="glyphicon glyphicon-print"></span></button></td>';
                                            } else {
                                        ...
                                        while ($row = mysql_fetch_array($val)) {
                                            ...
                                            while ($fila = mysql_fetch_array($consulta)) {
                                                ...
                                                if ($dif != 0) {
                                                    ...
                                                    echo '<td align="center"><a href="#" style="cursor:not-allowed" name="btn_cliente" id="btn_cliente" ><img src="../images/print.png" data-toggle="tooltip" data-placement="left" title = "Imprimir etiquetas de esta fecha" width="20" /></a></td>';
                                                    echo "</tr>";
                                                }
                                            }//fin while
