        ...
        <table border="0" align="center">
            <tr>
              <td><strong>Código País:</strong></td>
                <td><input type="text" id="codpais" name="codpais" value="" autofocus="autofocus"/>
                <strong>*</strong></td>
            </tr>
            <tr>
            	<td><strong>País:</strong></td>
                <td><input type="text" id="pais_dest" name="pais_dest" value=""/>
                <strong>*</strong></td>
            </tr>
            <tr>
...
<?php
   ...
   $pais_dest = strtoupper($_POST['pais_dest']);
	 
	 $sql="INSERT INTO tblpaises_destino (`codpais`, `pais_dest`) VALUES ('$codpais','$pais_dest')";
