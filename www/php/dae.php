...
<?php
echo '<form action="subirdae.php?finca='.$user.'" method="post" enctype="multipart/form-data" name="Upload" id="Upload" target="_blank">'
?>
...
<table width="50%" border="0" align="center" class="table table-striped" >
    ...
    <tr>
     ...
     <tr>
           ...
           <td>                
                <input type="file" name="archivo[]" id="archivo" class="btn btn-success"/>
                <?php
                if($_GET['id'] == 1)
