 ...
 <div class="btn-group">
  ...
  <div class="form-group">
    <label><strong>Ciudad:</strong></label>
      <select type="text" name="origen" id="origen" class="form-control" style="width: auto;">
          <?php 
            ...
            while($row2 = mysql_fetch_array($query)){
                  echo '<option value="'.$row2["codciudad"].'-'.$row2["pais_origen"].'">'.$row2["ciudad_origen"].'</option>'; 
                }
          ?>    
      </select>
  </div>
  ...
  <div class="form-group">
    <label><strong>Ciudad2:</strong></label>
      <select type="text" name="origen2" id="origen2" class="form-control" style="width: auto;">
          <?php 
            //Consulto la bd para obtener el codigo de la ciudad y el nombre de la ciudad origen
            $sql   = "SELECT * FROM tblciudad_origen";
            $query = mysql_query($sql,$conection);
            ...
            while($row3 = mysql_fetch_array($query)){
                  echo '<option value="'.$row3["codciudad"].'-'.$row3["pais_origen"].'">'.$row3["ciudad_origen"].'</option>'; 
                }
          ?>    
      </select>
  </div>
...
<div class="panel panel-default" id="po" style="display:none;">
  ...
  <div class="panel-body">
      <div class="col-md-12">
            ...
            <input type="submit" name="enviar4" id="enviar4" value="Buscar" class="btn btn-primary" title="Buscar" />
      </div>
  </div>
</div>
