                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="row" style="text-align: center;">
                            <label><h3>Cajas por rechazar</h3></label>
                        </div>
                    </div>
                    <div>
...
if (!$val) {
    ...
    while ($row = mysqli_fetch_array($val)) {
        ...
        if ($row['estado'] == 0) {
            echo "<td align='center'> Solicitada</td>";
        } elseif ($row['estado'] == 1) {
            echo "<td align='center'> Enviada</td>";
        }
        echo '<td align="center"><input name="cajas[]" type="checkbox" value="' . $row['codigo'] . '" title="Marcar caja"/></td>';

        echo "</tr>";
    }
    echo "<tr><td><strong>" . $cant . " Órden(es) encontradas</strong></td><td colspan='5'></td></tr>";
}
$_SESSION ['filtro'] = $sql;
?>			   
                        </tbody>
