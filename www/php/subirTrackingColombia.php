...
<div class="panel panel-primary">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
     <li><a href="subirTrackingColombia.php"><strong>Cargar Tracking</strong></a></li>
    </ul>
   <ul class="nav navbar-nav navbar-right">
    ...
    <div id="tracking">
      ...
      <form action="subirarchivoColombia.php" method="post" enctype="multipart/form-data" name="Upload" id="Upload">
        <input type="file" name="archivo" />
        <button type="submit" id="myButton" data-loading-text="Cargando..." class="btn btn-primary" autocomplete="off" data-toggle="tooltip" data-placement="right" title="Cargar trackings">Cargar trackings</button>
      </form>
     </div> 
    </div>
    <div class="panel-heading">
