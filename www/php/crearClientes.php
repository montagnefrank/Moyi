...
li a{
  ...
  function modificar(valor){
  	var v=valor;
  	window.open("modificarcliente.php?codigo="+v,"Cantidad","width=500,height=630,top=10,left=350");
  	return false;
  }
  function nueva(){
  ...
  function eliminar(valor){
  	var v=valor;
  	window.open("eliminarcliente.php?codigo="+v,"Cantidad","width=300,height=150,top=300,left=400");
  	return false;
  }
...
<thead>
  ...
  $sql = "SELECT tblcliente.*,tblusuario.cpnombre FROM tblcliente INNER JOIN tblusuario ON tblusuario.id_usuario = tblcliente.vendedor order by codigo";
      ...
      echo "<tr><td>".mysqli_error()."</td></tr>";
	   ...
	   while($row = mysqli_fetch_array($val)){
		   $cant ++;
			...
			echo "<td><strong>".$row['empresa']."</strong></td>";
			...
			echo '<td align="center"><input type="image" style="cursor:pointer" name="btn_cliente" id="btn_cliente" src="../bootstrap/fonts/glyphicons/glyphicons/glyphicons-151-edit.png" value="" data-toggle="tooltip" data-placement="left" title = "Modificar cliente" onclick = "modificar('.$row['id_vendedor'].')"/></td>';
			
			echo '<td align="center"><input type="image" style="cursor:pointer" name="btn_cliente" id="btn_cliente" src="../bootstrap/fonts/glyphicons/glyphicons/glyphicons-17-bin.png" value="" data-toggle="tooltip" data-placement="left" title = "Eliminar cliente"  onclick = "eliminar('.$row['id_vendedor'].')"/></td>';
			echo "</tr>";
	 }
	 			echo "<tr>
