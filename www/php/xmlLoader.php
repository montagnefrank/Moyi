...
if (!empty($insert_incoming_values)) {
...
if (!empty($insert_tblshipto_values)) {
...
if (!empty($insert_tblsoldto_values)) {
...
if (!empty($insert_tbldirector_values)) {
...
if (!empty($insert_ord_index1_values)) {
