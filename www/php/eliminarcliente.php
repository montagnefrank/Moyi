...
<form id="form1" name="form1" method="post" action="">
  <table width="300" border="0" align="center" class="alert">
    <tr>
      <td height="30" colspan="2" align="center"><strong><span id="result_box" lang="en" xml:lang="en">Esta seguro de eliminar el cliente</span>?</strong></td>
    </tr>
    <tr>
  ...
  $eliminado= mysql_query($sql,$link);
  	if($eliminado){
		echo("<script> alert ('Cliente eliminado correctamente');
		               window.close();					   window.opener.document.location='crearClientes.php';
		     </script>");
	 }else{
