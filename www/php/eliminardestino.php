...
<form id="form1" name="form1" method="post" action="">
  <table width="300" border="0" align="center" class="alert">
    <tr>
      <td height="30" colspan="2" align="center"><strong><span id="result_box" lang="en" xml:lang="en">Esta seguro de eliminar el destino</span>?</strong></td>
    </tr>
    <tr>
  ...
  <?php 
  if(isset($_POST["si"])){
  $sql="DELETE FROM tbldestinos WHERE iddestino='".$codi."'";
  $eliminado= mysql_query($sql,$link);
  	if($eliminado){
		echo("<script> alert ('Destino eliminado correctamente');
		               window.close();					   window.opener.document.location='gestionardestinos.php';
		     </script>");
	 }else{
