...
function processRate()
{
    ...
    $addressTo['AddressLine'] = '163 N Central Ave';
    $addressTo['City'] = 'ALISO VIEJO';
    $addressTo['StateProvinceCode'] = 'ss';
    $addressTo['PostalCode'] = '631053';
    ...
    $addressFrom['StateProvinceCode'] = 'FR';
...
{echo telefono("98 (74)-5897-6xc#54");
    print_r ($ex);
...
function telefono($numero,$pais){
    ...
    $nueva_cadena = ereg_replace("[^0-9]", "", $numero);
    $resultado = substr($nueva_cadena, 0, 10);
    return $resultado;
}
?>
