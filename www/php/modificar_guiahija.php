...
$guia_hija = $row['guia_hija'];
?>
<!DOCTYPE html>
<html lang="es">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>Guía Hja</title>
                ...
                $("#form1").validate({
                    ...
                    messages: {
                        guia: {
                            ...
                            maxlength: "11 caracteres como máximo",
    ...
    <body>
        <form id="form1" name="form1" method="post" novalidate="novalidate" action="" .error { color:red}>
              <table width="300" border="0" align="center">
                <tr>
                    <td width="300" height="36" align="center" bgcolor="#3B5998"><strong><font color="#FFFFFF">Modificar guía hija</font></strong></td>
                </tr>
            </table>
            <table width="300" border="0" align="center">
                ...
                <tr>
                    <td>
                        <table border="0" align="center" width="300">
                            <tr>
                                <td><strong>HAWB-GUIA:</strong></td>
                                <td><input type="text" id="guia" name="guia" value="<?php echo $guia_hija; ?>" autofocus="autofocus"/>*</td>
                            </tr>
                            <tr>
