...
<form id="form" name="form" method="post">
 <div class="row">
    ...
    <div class="col-md-1">
         <input type="image" style="cursor:pointer" id="imprimir"  name="imprimir"class= "imprimir" src="../images/print.ico" heigth="40" value="" data-toggle="tooltip" data-placement="left" title = "Exportar Reporte Excel" width="30" formaction = "crearReportExcel.php"/>
   </div>
</div>   
...
<table width="50%" border="0" align="center" class="table table-striped" >  
  ...
  <?php
			  $sql =   "SELECT id_orden_detalle,estado_orden,Ponumber, Custnumber, tracking, cpitem, delivery_traking,ShipDT_traking, soldto1
						...
						WHERE ShipDt_traking <= '".date('Y-m-d')."' AND tracking = '' AND estado_orden = 'Active' and origen = 'GYE-ECUADOR'";
