...
$directorio = opendir("C:\Program Files\RSSBus\RSSBus Server\data\as2connector\profiles\COMMERCEHUB\Irregulares"); //ruta de archivos XML
...
while ($archivo = readdir($directorio)) { //obtenemos el primer archivo y luego otro sucesivamente
    ...
    if (!is_dir($archivo)) { //verificamos si es o no un directorio
        ...
        $archivo = "C:\Program Files\RSSBus\RSSBus Server\data\as2connector\profiles\COMMERCEHUB\Irregulares" . "\\" . $archivo;
