                ...
                $('#codigo').keydown(function (e) {
                    if (e.keyCode == 13) {
                        ...
                        $.post('hash_translate.php', 'val=' + codigobarra, function (response) {
                            ...
                            {
                                $('#ventModal').find('#mensaje_error').html('<strong>El código de barras escaneado no tiene la cantidad correcta de digitos</strong>');
                            ...
                            $.ajax({
                                ...
                                success:  function (response) {
                                    ...
                                    if (response.error == 3) {
                                        $('#ventModal').find('#mensaje_error').html('<strong>  Esa caja no ha sido solicitada, O fue eliminada / archivada en alg&uacute;n punto del proceso. Contacte al departamento de compras y notifique la caja. <br /><font color="red">**Es importante que separe la caja del resto de la carga para identificarla.</font></strong>');
                                        $('#ventModal').modal('show');
                                        $('#imagealert').attr('src', '../images/alertsign.png');
                                        ion.sound.play("error");
                                        return;
                                    }
                                    if (response.error == 4) {
                                        $('#ventModal').find('#mensaje_error').html('<strong>  Error: No se pudo actualizar el estado del pedido.</strong>');
                                        $('#ventModal').modal('show');
                                        ion.sound.play("error");
                                        return;
                                    }
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table width="100%" border="0" align="center" class="table table-striped" >
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-md-8">
                                        <input type="text" id="codigo" class="form-control" name="codigo" autofocus />
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <table id="tabla" border="0" class="nowrap stripe row-border" cellspacing="0" width="100%">
                        ...
                        <tbody> 
                            ...
                            $sql1 = "SELECT * FROM tblcoldroom INNER JOIN tbletiquetasxfinca ON tblcoldroom.codigo = tbletiquetasxfinca.codigo where entrada= 'Si' AND salida ='No' AND tbletiquetasxfinca.archivada='No' AND tbletiquetasxfinca.estado='1'";
                                ...
                                <table width="372" border="0" align="center" class="alert">
                                    <tr>
                                        <td height="30" colspan="2" align="center"><p><strong><span id="result_box" lang="en" xml:lang="en"> 
                                                        <img  id="imagealert" src="../images/error.jpg" width="74" height="69" alt="d" />
                                                    </span></strong></p>
