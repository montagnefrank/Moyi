...
$sql = "SELECT * FROM tblciudad_origen WHERE idciudad =".$id.";";
 ...
 <tr height="20"><td></td></tr>
        ...
        <table border="0" align="center">
            <tr>
              <td><strong>Código:</strong></td>
                <td><input type="text" id="codciudad" name="codciudad" value="<?php echo $row['codciudad'];?>" />
                <strong>*</strong></td>
            </tr>
            <tr>
              <td><strong>Ciudad:</strong></td>
                <td><input type="text" id="ciudad" name="ciudad" value="<?php echo $row['ciudad_origen'];?>" />
                <strong>*</strong></td>
            </tr>
            <tr>
              <td><strong>País:</strong></td>
                <td><input type="text" id="pais" name="pais" value="<?php echo $row['pais_origen'];?>" autofocus="autofocus"/>
                <strong>*</strong></td>
            </tr>
  ...
  <?php
   ...
   $codciudad = strtoupper($_POST['codciudad']);
	 ...
	 $sql="UPDATE tblciudad_origen set pais_origen='".$pais."' , ciudad_origen='".$ciudad."', codciudad='".$codciudad."'  where idciudad='".$id."' ";
