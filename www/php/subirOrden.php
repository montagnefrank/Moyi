...
<div class="panel panel-primary">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
   ...
   <ul class="nav navbar-nav navbar-right">
    ...
    <div id="orden">
      <h3>Seleccione el archivo de órdenes</h3>
      <!-- Subir varios archivos-->
      <form action="subirarchivo.php" method="post" enctype="multipart/form-data" name="Upload" id="Upload">
        <input type="file" name="archivo[]"/><button type="submit" id="myButton" data-loading-text="Cargando..." class="btn btn-primary" autocomplete="off" data-toggle="tooltip" data-placement="right" title="Cargar órdenes">Cargar órdenes</button>
      </form>
    </div> 
    </div>
    <div class="panel-heading">
