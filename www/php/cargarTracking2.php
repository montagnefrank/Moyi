...
//Aqui recorro cada una de las filas leida de las ordenes
        for ($j = 2; $j <= $fila; $j++) {
            ...
            if ($Ponumber == '' || $CustNumber == '') {
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////////////////ELIMINAMOS LA VERIFICACION PARA ESTE CASO DE SUBIDA SIN RESTRICCIONES
...
//        }
                ...
                $query3 = "select id_orden_detalle,tracking,Ponumber from  tbldetalle_orden where Ponumber= '$Ponumber' and Custnumber = '$CustNumber' and cpitem ='$item' AND estado_orden!='Canceled' LIMIT 1";
