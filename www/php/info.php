...
<form id="form1" name="form1" method="post" action="">
  <table width="372" border="0" align="center" class="alert">
    <tr>
	  ...
	  if ($id == 0){ // Si es error 
		 ...
		 //echo '<bgsound src="../sounds/error.wav" loop="true" balance="b" volume="v"></bgsound>';
	  }else{
	  		if ($id == 1){ // Si es informacion
      			echo '<img src="../images/advertencia.jpg" width="74" height="69" alt="d" />';
	        }else{ // si es OK
				echo '<img src="../images/ok.jpg" width="74" height="69" alt="d" />';  
	        }
	  }
      ?>
      </span></strong></p>
  ...
  echo("<script>window.close();
                window.opener.document.location='verificartrack.php';
        </script>");
  ?>
</body>
</html>