                                            ...
                                            <div class="table-responsive">
                                                <table width="50%" border="0" align="center" class="table table-responsive">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="200"> 
                                                            <strong>Desde:</strong>
                                                            <input class="datepicker" name="txtinicio" type="text" id="txtinicio" readonly="readonly" size="20"/>
                                                            <script type="text/javascript">
                                ...
                                if (isset($_POST['buscar'])) {
                                                ...
                                                <div align="right" class="row">
                                                    ...
                                                    <div class="col-md-2" align="right">
                                                        <form action="crearxml.php" method="post" target="_blank">
                                                            <button name="btn_xml" id="btn_xml" class = "btn btn-primary"><img src="../images/xml.png" width="30" height="30" /> Exportar a XML </button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    if ($fecha1 != '' && $fecha2 != '') {
                                        ...
                                        $select_consecutivo = "SELECT ebing 
                                                                ...
                                                                ORDER BY ebing DESC 
                                                                LIMIT 1";
                                        $result_consecutivo = mysql_query($select_consecutivo, $conection);
                                        $row_consecutivo = mysql_fetch_array($result_consecutivo);
                                        ...
                                        $result_ebing = mysql_query($select_ebing, $conection);
                                        while ($row_ebing = mysql_fetch_array($result_ebing)) {
                                        ...
                                        if (isset($where_ponumberebing)) {
                                            ...
                                            $result_update_ebing = mysql_query($update_ebing, $conection);
                                        }
                                        ...
                                        $result_costo = mysql_query($select_costo, $conection) or die("Error consultando en la tabla de costos");
                                        $num_costo = mysql_num_rows($result_costo);
                                        ...
                                        $select_detallecosto = "SELECT SUM(unitprice),delivery_traking,Ponumber,eBing
                                                                    ...
                                                                    AND status='Shipped'
                                                                    GROUP BY Ponumber";
                                        $result_detallecosto = mysql_query($select_detallecosto, $conection) or die("Error sumando los costos en el detalle de orden");

                                        //SI EL PONUMBER NO EXISTE EN LA TABLA DE COSTOS
                                        if ($num_costo == 0) {

                                            //ALIMENTAMOS LA DATA PARA LOS QUERY
                                            while ($row_detallecosto = mysql_fetch_array($result_detallecosto)) {
                                            ...
                                            if (isset($insert_valuescosto)) {
                                                ...
                                                $result_insert_costo = mysql_query($insert_costo, $conection) or die("Error Insertando en la tabla de costos");
                                            }
                                            ...
                                            if (isset($where_ponumbercosto)) {
                                                ...
                                                $result_delete_costo = mysql_query($delete_costo, $conection) or die("Error Eliminando de la tabla de costos");
                                            }
                                            ...
                                            if (isset($where_ponumbercosto)) {
                                                $update_costo = "UPDATE tblcosto 
                                                                ...
                                                                WHERE po IN (" . $where_ponumbercosto . ") ";
                                                $result_update_costo = mysql_query($update_costo, $conection) or die("Error Actualizando la tabla de costos");
                                            }
                                        }
                                        ...
                                        $select_pack = "SELECT tracking 
                                                            ...
                                                            AND status='Shipped' 
                                                            AND estado_orden='Active'";
                                        $result_pack = mysql_query($select_pack, $conection) or die("Error consultando la tabla para los PackageDetailId");
                                        ...
                                        if (isset($where_trackingpack)) {
                                            ...
                                            $result_update_pack = mysql_query($update_pack, $conection) or die("Error Actualizando los PackageDetailId");
                                        }
                                        ...
                                        $select_report = "SELECT vendor,Ponumber,poline,cpcantidad,ups, 
                                                            ...
                                                            AND vendor = 'Costco'
                                                            ORDER BY eBing";
                                        $result_report = mysql_query($select_report, $conection) or die("Error Consultando el reporte en pantalla");
