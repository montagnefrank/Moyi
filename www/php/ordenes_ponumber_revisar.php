...
<!--    <div class="col-md-2">
    ...
    <div class="col-md-12">
    	<h3><strong>Lista de Órdenes mayores a 2 pedidos para Auditar</strong></h3>
    </div>
       
</div>
<table width="50%" border="0" align="center" class="table table-striped" >  
  <tr>
    <td width="20%" align="center"><strong>Id Detalle Orden</strong></td>
  ...
  <?php
			  $sql ='SELECT count(Ponumber) as cant,Ponumber,id_detalleorden,cpitem FROM `tbldetalle_orden` 
			  ...
			  if(!$val){
				echo "<tr><td>".mysqli_error()."</td></tr>";
				   ...
				   while($row = mysqli_fetch_array($val)){
					   $cant ++;
						echo "<tr>";
                                                echo "<td align='center'>".$row['id_detalleorden']."</td>";
