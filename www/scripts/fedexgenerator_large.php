...
if ($pais == 'US') {
    ...
    while ($rowr = mysqli_fetch_assoc($query)) {
        if ($i == 0) {
            echo "0,\"20\"1,\"IPD\"4,\"" . $rowr["nombre_compania"] . "\"5,\"FARMS ECUADOR\"6,\"" . $rowr["farm"] . "\"7,\"Quito\"9,\"170109\"10,\"992001895\"32,\"ALINA ALZUGARAY\"117,\"EC\"183,\"593-224-0163\"1150,\"ALINA ALZUGARAY\"11,\"FEDEX EXPRESS\"12,\"VIA FEDEX IPD\"13,\"6100 NW 36 STREET\"14,\"BUILDING 831\"15,\"MIAMI\"16,\"FL\"17,\"33115\"18,\"7862656564\"50,\"US\"20,\"502054406\"23,\"3\"24,\"" . date('Y') . date('m') . date('d') . "\"68,\"USD\"70,\"3\"71,\"502054406\"75,\"KGS\"1273,\"01\"1274,\"18\"541,\"YNNNNNNNN\"542,\"EBDM" . $ii . "\"1355,\"FEDEX\"1485,\"ALEX ALFONSO\"1486,\"EBLOOMS\"1487,\"2231 SW 82 PL\"1488,\"MIAMI FLORIDA 33155\"1489,\"MIAMI\"1490,\"FL\"1491,\"33155\"1492,\"1-855-532-5666\"1585,\"US\"1586,\"Y\"99,\"\"";
            echo "\r\n";
            echo "\r\n";
//            echo print_r($rowr); echo "\r\n";
        ...
        if ($pesototal > 101 && $rowr["cpitem"] !== "1021437" && $rowr["cpitem"] !== "1021440" && $rowr["cpitem"] !== "1021441"  
                    ...
                    && $rowr["cpitem"] !== "100511" && $rowr["cpitem"] !== "100502" && $rowr["cpitem"] !== "100298"
                    && $rowr["cpitem"] !== "200201" && $rowr["cpitem"] !== "200203" && $rowr["cpitem"] !== "200206"
                    && $rowr["cpitem"] !== "200207") {
